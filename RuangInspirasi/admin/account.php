    ...
    <nav class="bg-[#272343] m-1 rounded-tl-xl py-10 text-white">
      <div class="mx-15 flex justify-between max-sm:mx-5">
        <div class="font-bold text-2xl">
          <a href="index.php"><h1>Daftar Pengguna</h1></a>
        </div>
    ...
    <section class="max-w-7xl mx-auto">
      <div class="mx-10 my-10 max-sm:mx-2">
        <div class="flex justify-between items-center bg-[#272343] p-5 rounded-t">
          <h1 class="font-semibold text-xl py-2 text-white">Account</h1>
        </div>
        ...
        <table class="min-w-full">
          ...
          <tbody>
            ...
            <tr class="border-b bg-gray-300 hover:bg-gray-400">
              <td class="py-3 px-4 text-left"><?= $data['username']?></td>
              <td class="py-3 px-4 text-left"><?= $data['full_name']?></td>
              <td class="py-3 px-4 text-left"><?= $data['phone']?></td>
              <td class="py-3 px-4 text-center">
                <div class="">
                  <button class="text-red-500 hover:underline"><a href="delete_account.php?id=<?php echo $data['account_id'] ?>">Hapus</a></button>
                </div>
              </td>
            </tr>
            <?php
